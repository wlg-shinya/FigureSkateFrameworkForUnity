...
{
    [CreateAssetMenu(fileName = "ElementPlaceableSetConditionLimit3CombinationThird", menuName = "ScriptableObjects/ProgramComponentCondition/ElementPlaceableSetConditionLimit3CombinationThird")]
